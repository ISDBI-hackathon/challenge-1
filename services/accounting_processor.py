...
class AccountingProcessor:
    def __init__(self, fas_docs_dir: str):
    ...
    def generate_entries(self, data: ExtractedData, fas_standard: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "You are an expert in AAOIFI accounting standards. Generate compliant accounting entries based on the provided FAS standard context. Return only valid JSON, no markdown or additional text."},
